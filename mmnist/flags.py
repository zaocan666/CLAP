...
parser.add_argument('--likelihood_mnist', type=str, default='laplace', help="output distribution")

# data
parser.add_argument('--unimodal-datapaths-train', type=str, default='/data/train/', help="directories where training data is stored")
parser.add_argument('--unimodal-datapaths-test', type=str, default='/data/test/', help="directories where test data is stored")
